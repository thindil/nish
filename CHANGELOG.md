...
- Commands `variable delete`, `variable edit` can now be executed without
  entering the index of the variable. In that situation, the user will be asked
  for the index of a variable from their list
