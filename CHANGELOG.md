...
- Command `plugin remove` can now be executed without entering the index of
  the plugin. In that situation, the user will be asked for the index of a
  plugin from their list
